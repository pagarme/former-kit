...
const getMock = detailsClick => ({
  columns: [
    ...
    { title: 'Transaction ID', acessor: ['id'], orderable: true },
    { title: 'Date', acessor: ['date_created'], orderable: true },
    { title: 'Payment Method', acessor: ['payment_method'], orderable: true },
    { title: 'Paid Amount', acessor: ['paid_amount'], orderable: true },
    { title: 'Cost', acessor: ['cost'], orderable: true },
    { title: 'Amount', acessor: ['amount'], orderable: true },
    { title: 'E-mail', acessor: ['customer', 'email'], orderable: true },
    { title: 'Antifraud Score', acessor: ['antifraud_score'], orderable: true },
    { title: 'Installments', acessor: ['installments'], orderable: true },
    { title: 'Name', acessor: ['customer', 'name'], orderable: true },
    {
      title: 'Details',
      isAction: true,
      orderable: false,
